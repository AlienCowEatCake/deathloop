...
#include "ui_gframe_speed.h"
#include "main.h"

gframe_speed::gframe_speed(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::gframe_speed)
{
    ui->setupUi(this);
...
gframe_speed::~gframe_speed()
{    
    delete ui;   
}

void gframe_speed::update()
{
    clear();
    iter = maction;
