...
APP_PATH="."
DESKTOP_PATH="src/Deathloop/resources/platform/linux/${IDENTIFIER}.desktop"
ICON_PATH="src/Deathloop/resources/icon/ball.svg"
ICONS_DIR_PATH="src/Deathloop/resources/icon/ball_icons"
DEBIAN_DIR_PATH="src/Deathloop/resources/platform/debian"
...
mkdir -p "${BUILDDIR}"
cd "${BUILDDIR}"
${CMD_QMAKE} -r CONFIG+="release" "../${PROJECT}.pro"
make
